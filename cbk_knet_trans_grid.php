...
if(!class_exists("Alnazer_Cbk_KNET_Trans_Grid")){
    /**
     * Class Alnazer_Cbk_KNET_Trans_Grid
     */
    class Alnazer_Cbk_KNET_Trans_Grid extends WP_List_Table
    {
        public $table;
        public $db;
        public function __construct($args = array())
        {
            ...
            $this->db = $wpdb;
            $this->table = $this->db->prefix.Alnazer_CBK_KNET_TABLE;
        }
            ...
            <form action="admin.php" method="get">
                ...
                <div class="cbk-knet-field">
                    ...
                    <select name="status" id="status">
                        ...
                        <option value="fail" <?php echo (isset($_REQUEST["status"]) && sanitize_text_field($_REQUEST["status"]) =="fail") ? "selected" : "" ?>><?php echo __('Fail', "cbk_knet") ?></option>
                        <option value="success" <?php echo (isset($_REQUEST["status"]) && sanitize_text_field($_REQUEST["status"]) =="success") ? "selected" : "" ?>><?php echo __('Success', "cbk_knet") ?></option>
                    </select>
                </div>
                <div class="cbk-knet-field">
                ...
                <div>
                    ...
                    <a class="button reset" href="admin.php?page=<?php echo esc_attr($_REQUEST['page'] ?? ""); ?>"><?php  echo __('Reset', "cbk_knet") ?></a>
                    <?php $http_build_query = $_GET; unset($http_build_query["page"])  ?>
                    <a class="button reset" href="admin.php?page=<?php echo esc_attr($_REQUEST['page'] ?? ""); ?>&cbk_knet_export=excel&<?php echo http_build_query($http_build_query) ?>"><?php  echo __('Export excel', "cbk_knet") ?></a>
                    <a class="button reset" href="admin.php?page=<?php echo esc_attr(REQUEST['page'] ?? ""); ?>&cbk_knet_export=csv&<?php echo http_build_query($http_build_query) ?>"><?php  echo __('Export csv', "cbk_knet") ?></a>
                </div>
...
if(!class_exists("Alnazer_CBK_KNET_Plugin")){
    /**
     * Class Alnazer_CBK_KNET_Plugin
     */
    class Alnazer_CBK_KNET_Plugin
{
...
// class constructor
    ...
    public function screen_option() {
        ...
        $this->transations_obj = new Alnazer_Cbk_KNET_Trans_Grid();
    }
